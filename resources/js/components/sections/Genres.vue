<template>
    <div class="card bg-warning-subtle w-xs">
        ...
        <div class="list-group overflow-y-auto scrollbar-thin user-select-none">
            <div class="list-group-item list-group-item-action cursor-pointer" :class="{ active: genre === uiStore.selectedGenre }" v-for="genre in genres" :key="genre" @click="uiStore.selectGenre(genre)">
                {{ genre }}
            </div>
        </div>
    </div>
