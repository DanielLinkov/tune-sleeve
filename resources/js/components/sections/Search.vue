...
<template>
    <div class="w-full">
        <div class="card w-120 mx-auto mt-10">
            <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div v-else>
                        ...
                        >
                            <div class="">
                                <div class="d-flex justify-content-between">
                                    ...
                                    @click="playerStore.playTrackId(track.id)"
                                    >{{ track.title }}</button>
                                ...
                                <div class=""><button class="btn text-xs!" @click="uiStore.selectAlbum(track.album_id);uiStore.setPage('album')">{{ libraryStore.getAlbum(track.album_id)?.title || "Unknown Album" }}</button></div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul class="list-group">
                        ...
                        >
                            <div class="">
                                <div><button class="btn p-0" @click="uiStore.selectAlbum(album.id);uiStore.setPage('album')">{{ album.title }}</button></div>
                                <div class="text-muted">by <button class="btn p-0" @click="uiStore.selectArtist(album.artist_id);uiStore.setPage('artist')">{{ libraryStore.getArtist(album.artist_id)?.name || "Unknown Artist" }}</button></div>
                            </div>
                        </li>
                    </ul>
                </div>
